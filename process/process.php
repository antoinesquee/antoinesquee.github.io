...
MAIL_FROM = 'budanth@yandex.ru', // от какого email будет отправляться письмо
...
MAIL_ADDRESS = 'rexen96@yandex.ru', // кому необходимо отправить письмо
...
MAIL_SMTP_USERNAME = 'budanth@yandex.ru', // SMTP-пользователь
MAIL_SMTP_PASSWORD = 'R43aDLyBu8DFAS'; // SMTP-пароль
